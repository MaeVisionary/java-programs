...
public class Program_2_Start extends javax.swing.JFrame {

    /**
     * Creates new form Program_2
     */
    
    public Program_2_Start() {
        initComponents();
...
private void resetButtonColors() {
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Number of Friends:");
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(input2, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(64, 64, 64)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(input4, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void SubmitBTNMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SubmitBTNMouseClicked
        ...
        try {
            // Get inputs
            int friends          = Integer.parseInt(input1.getText().trim());
            double transport     = Double.parseDouble(input2.getText().trim());
            double accommodation = Double.parseDouble(input3.getText().trim());
            double food          = Double.parseDouble(input4.getText().trim());
            double other         = Double.parseDouble(input5.getText().trim());

            // Calculate total and per-person expenses
            double total     = transport + accommodation + food + other;

            // Handle division by zero
            double perPerson = (friends > 0) ? (total / friends) : 0;

            // Format and display result
            String result  = "";
            result       += "TRIP EXPENSE SUMMARY\n";
            result       += "____________________________________\n\n";
            result       += " Number of Friends: " + friends + "\n\n";
            result       += " Total Expense:      $" + String.format("%.2f", total) + "\n";
            result       += " Expense per Person: $" + String.format("%.2f", perPerson) + "\n";
            result       += "____________________________________";

            output.setText(result);

        } catch (NumberFormatException e) {
            output.setText("Invalid input! Please enter numbers only.");
        } catch (ArithmeticException e) {
            output.setText("Error: Number of friends cannot be zero.");
        } catch (Exception e) {
