...
private void resetButtonColors() {
    ...
    private void SubmitBTNMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SubmitBTNMouseClicked
        ...
        int friends = Integer.parseInt(input1.getText());
        double transport = Double.parseDouble(input2.getText());
        double accommodation = Double.parseDouble(input3.getText());
        double food = Double.parseDouble(input4.getText());
        double other = Double.parseDouble(input5.getText());
